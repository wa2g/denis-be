  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      >
        ...
        <div className="font-semibold text-gray-900">{formatRole(userRole)}</div>
        <svg
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50">
          <button
            ...
            className="w-full px-4 py-2 text-sm text-gray-900 hover:bg-gray-100 text-left flex items-center space-x-2"
          >
            <svg
              className="w-4 h-4"
              fill="none"
